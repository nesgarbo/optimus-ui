            ...
            <p-table [value]="products()" [tableStyle]="{ 'min-width': '50rem' }" [paginator]="true" [rows]="5">
                ...
                <ng-template #body let-product>
                    <tr>
                        ...
                        <td>$ {{ product.price }}</td>
                        <td>
                            <img [src]="'https://optimus.openng.org/demo/product/' + product.image" [alt]="product.image" class="w-16 shadow-sm" width="300" height="200" />
                        </td>
                        <td>
                    ...
                    <div *ngIf="selectedProduct()" class="rounded flex flex-col">
                        <div class="flex justify-center rounded">
                            <div class="relative mx-auto">
                                <img class="rounded w-44 sm:w-64" [src]="'https://optimus.openng.org/demo/product/' + selectedProduct().image" [alt]="selectedProduct().name" width="300" height="200" />
