                ...
                >
                    ...
                    <ng-template #body let-product>
                        <tr>
                            ...
                            <td>
                                <img [src]="'https://optimus.openng.org/demo/product/' + product.image" [alt]="product.name" style="width: 64px" class="rounded" width="300" height="200" />
                            </td>
                ...
                <p-dialog [(visible)]="productDialog" [style]="{ width: '450px' }" header="Product Details" [modal]="true">
                    <ng-template #content>
                        <div class="flex flex-col gap-6">
                            <img [src]="'https://optimus.openng.org/demo/product/' + product.image" [alt]="product.image" class="block m-auto pb-4" *ngIf="product.image" width="300" height="200" />
                            <div>
