...
@Component({
    ...
    template: `<app-doc
        ...
        metaDescription="Optimus UI components animate with native CSS. Every built-in animation is listed here, with how to change the defaults per component or for the whole app."
        header="Animations"
