...
@Component({
    template: `<app-doc
        docTitle="Angular Knob Component - Optimus UI"
        header="Knob"
        description="Knob is a form component to define number inputs with a dial."
        metaDescription="Knob is a form component to define number inputs with a dial. Examples cover basic, min/max, step, template, stroke, size, color, reactive and readonly."
        [docs]="docs"
        [apiDocs]="['Knob']"
        themeDocs="knob"
        [ptDocs]="ptComponent"
