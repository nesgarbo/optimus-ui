...
@Component({
    template: `<app-doc
        docTitle="Angular OrderList Component - Optimus UI"
        header="OrderList"
        description="OrderList is used to sort a collection."
        metaDescription="OrderList is used to sort a collection. Examples cover basic, filter, template and drag & drop."
        [docs]="docs"
        [apiDocs]="['OrderList']"
        [ptDocs]="ptComponent"
        themeDocs="orderlist"
