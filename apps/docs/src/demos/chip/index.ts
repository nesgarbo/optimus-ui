...
@Component({
    ...
    imports: [AppDoc],
    template: ` <app-doc
        docTitle="Angular Chip Component - Optimus UI"
        header="Chip"
        description="Chip represents entities using icons, labels and images."
        metaDescription="Chip represents entities using icons, labels and images. Examples cover basic, icon, image and template."
        [docs]="docs"
        [apiDocs]="['Chip']"
        [ptDocs]="ptComponent"
        themeDocs="chip"
