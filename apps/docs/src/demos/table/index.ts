...
@Component({
    template: `<app-doc
        docTitle="Angular Table Component - Optimus UI"
        header="Table"
        description="Table displays data in tabular format."
        metaDescription="Table displays data in tabular format. Examples cover import, basic, dynamic columns, template, size, grid lines, striped rows, conditional style and loading."
        [docs]="docs"
