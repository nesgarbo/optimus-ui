                                        ...
                                        <div style="padding-top:6px;border-top:1px solid rgba(255,255,255,0.1)">
                                            ...
                                            <div style="display:flex;gap:4px;flex-wrap:wrap">
                                                @for (pr of pairs(it.session); track pr) {
                                                    <span
                                                        [style]="'font-size:10px;padding:2px 5px;border-radius:3px;font-family:ui-monospace,monospace;font-weight:600;background:' + sessionColor(it.session) + '22;color:' + sessionColor(it.session)"
                                                        >{{ pr }}</span
                                                    >
                                                }
                                            </div>
...
export class PolarGlobalFxMarket24HourTradingVolumeCycleDoc {
