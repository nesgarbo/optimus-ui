...
@Component({
    ...
    template: `
        ...
        <div class="card">
            <p-scheduler-root locale="en-US" view="day" [events]="events" [categories]="categories" categoryField="categoryId" [date]="date" [dayStartHour]="7" [dayEndHour]="19" [slotMinutes]="30">
                <p-scheduler-header>
